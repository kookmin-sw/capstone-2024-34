        ...
        <div>
          {success === true ? (
            <div className="grid w-full max-w-full gap-4 sm:gap-6">
              <div className="min-h-72 max-w-full overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm lg:col-span-2">
                ...
                {data_yara.rule ? (
                  <div className="relative h-full w-full">
                    <MonacoEditor
                      className="absolute left-0 top-0 h-full w-full py-4"
                    ...
                    />
                    <div className="absolute flex h-full w-full animate-pulse flex-col items-center justify-center bg-neutral-100">
                      <div role="status">
                        <svg
                          aria-hidden="true"

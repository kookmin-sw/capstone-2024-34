    ...
    >
      ...
      >
        <ul className="space-y-1.5">
          <li>
            <Link
              className={`flex items-center gap-x-3 rounded-lg px-2.5 py-2 text-sm text-white focus:outline-none focus:ring-1 focus:ring-gray-600 ${
                isActive("/dashboard")
                  ? "bg-gray-700"
          ...
          <li>
            <button
              type="button"
              className=" flex w-full items-center gap-x-3.5 rounded-lg px-2.5 py-2 text-start text-sm text-white hover:bg-gray-800 focus:outline-none focus:ring-1 focus:ring-gray-600 "
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <ul className="ps-2 pt-2">
              <li>
                <Link
                  className={`flex items-center gap-x-3.5 rounded-lg px-2.5 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-gray-600 ${
                    isActive("/generate/rule/yara/manual")
              ...
              <li>
                <Link
                  className={`flex items-center gap-x-3.5 rounded-lg px-2.5 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-gray-600 ${
                    isActive("/generate/rule/yara/auto")
                      ? "bg-gray-700 text-white"
                      : "text-gray-300 hover:bg-gray-800 hover:text-white"
                  }`}

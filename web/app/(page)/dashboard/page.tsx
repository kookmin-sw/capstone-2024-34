      ...
      <div className="grid w-full max-w-full gap-4">
        ...
        <div className="grid max-w-full grid-rows-1 gap-4 sm:gap-6 xl:grid-cols-2">
          ...
          <div className="h-full overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
            ...
            {/* 그래프 라이브러리 삽입 영역 */}
            <div className="flex min-h-96 items-center justify-center px-6 py-4 ">
              <TrafficGraph />
            </div>
          </div>
          ...
          <div className="w-full">
            <div className="flex h-full flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
              ...
              <div className="flex h-full w-full max-w-[90vw] items-center justify-center gap-3 overflow-x-auto py-4">
                <WordCloud />
              </div>
            </div>
          </div>
        ...
        {/* 개별파일 검사결과 카드 영역 */}
        <div className="w-full max-w-full overflow-x-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
          <div className="grid gap-3 border-b border-gray-200 px-6 py-4 md:flex md:items-center md:justify-between">
            <div>
              <h2 className="text-xl font-semibold text-gray-800">
                개별파일 검사결과
          ...
          <div className="grid w-full gap-3 border-b border-gray-200 px-6 py-4 md:flex md:items-center md:justify-between">
                  ...
                  >
                    <div className="divide-y divide-gray-200">
                      ...
                      >
                        ...
                        />
                        <span className="ms-3 text-sm text-gray-800">정상</span>
                      </label>
                      <label
                      ...
                      >
                        ...
                        />
                        <span className="ms-3 text-sm text-gray-800">대기</span>
                      </label>
                      <label
                      ...
                      >
                        ...
                        />
                        <span className="ms-3 text-sm text-gray-800">악성</span>
                      </label>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex w-full items-center justify-between gap-3 border-t border-gray-200 px-6 py-4">

...
if __name__ == '__main__':
    ...
    # default thh thh
    dataset = ['./iotpot/48.pkl', './iotpot/48.pkl', './url/url_addr.pkl', './url/url_addr.pkl', './url/url_addr.pkl', './iotpot/48.pkl']
    save_name = ['iot', 'iot_dhh', 'url', 'url_dhh', 'url_parser', 'iot_M14']
